...
INSERT INTO "outfunds__Disbursement__c" VALUES(1,'10000.0','2020-03-28','EFT','2020-03-28','Paid','Initial','5');
INSERT INTO "outfunds__Disbursement__c" VALUES(2,'5000.0','2019-07-09','EFT','2019-07-09','Paid','Initial','6');
INSERT INTO "outfunds__Disbursement__c" VALUES(3,'5000.0','2020-07-09','','2020-07-09','Paid','Interim','6');
INSERT INTO "outfunds__Disbursement__c" VALUES(4,'5000.0','','EFT','2021-07-09','Scheduled','Final','6');
INSERT INTO "outfunds__Disbursement__c" VALUES(5,'40000.0','2019-05-14','EFT','2019-05-14','Paid','Final','2');
...
INSERT INTO "outfunds__Funding_Request_Role__c" VALUES(1,'Grant Manager','Current','2','5');
INSERT INTO "outfunds__Funding_Request_Role__c" VALUES(2,'Applicant','Current','3','5');
INSERT INTO "outfunds__Funding_Request_Role__c" VALUES(3,'Applicant','Former','7','2');
...
INSERT INTO "outfunds__Funding_Request__c" VALUES(3,'Skills for Success','2020-05-31','','','','','Region','Adults;Women','','46000.0','Skills for Success addresses an existing gap for at-risk women seeking to learn technical and soft skills to help them find gainful employment in the community. Participants of the program receive:

* Vouchers for free community college courses on select topics, such as bookkeeping, computer literacy, and communication skills.
* Help developing a resume and interview preparation. 
* One-on-one mentoring with a female business owner in the community.
* Ongoing support from the STEPS staff.','In progress','','','1 year','6','6','4');
INSERT INTO "outfunds__Funding_Request__c" VALUES(4,'Grantwood City Food Bank','','','','','','City','Below Poverty level;Economically Disadvantaged People;Homeless','','100000.0','Grantwood City Food Bank','In progress','','','','','2','4');
INSERT INTO "outfunds__Funding_Request__c" VALUES(5,'Takagawa Institute: Relief and Reinvestment Grant','2020-03-11','10000.0','2020-03-28','2020-03-28','Fully awarded.','Country','Immigrants and Refugees','10000.0','10000.0','','Fully Disbursed','2021-03-27','2020-03-28','One time payment with one year follow up','3','3','5');
INSERT INTO "outfunds__Funding_Request__c" VALUES(6,'Eager Beavers Read!','2019-04-25','15000.0','2019-07-09','','','City','Children and Youth','15000.0','15000.0','Eager Beavers Read! is an after school program that helps foster a love of reading in our 1st - 5th grade classes and also provides a safe place for students to go between 3:00 pm and 4:30 pm. Younger children will be paired up with an older student to help expand their early literacy skills, while older students work to develop mentoring skills and confidence.','Awarded','2022-08-13','2019-08-14','3 years','4','5','2');
...
INSERT INTO "outfunds__Requirement__c" VALUES(1,'Budget Report','','2020-09-14','<p>Budget Report</p>','Open','Report','','5','3');
INSERT INTO "outfunds__Requirement__c" VALUES(2,'Outcome Report','','2021-03-31','<p>Outcome Report</p>','Open','Outcome','','5','3');
INSERT INTO "outfunds__Requirement__c" VALUES(3,'Application','2020-03-11','2020-12-30','<p>Application</p>','Accepted','Final Application','','5','3');
INSERT INTO "outfunds__Requirement__c" VALUES(4,'Letter of Intent','2019-04-25','2019-12-30','<p><span style="font-family: Arial; font-size: 10pt; color: rgb(0, 0, 0);">Cover letter</span></p>','Accepted','Letter of Intent','','6','4');
INSERT INTO "outfunds__Requirement__c" VALUES(5,'Application','2019-04-25','2019-12-30','<p><span style="font-family: Arial; font-size: 10pt; color: rgb(0, 0, 0);">Application</span></p>','Accepted','Final Application','','6','4');
INSERT INTO "outfunds__Requirement__c" VALUES(6,'Outcome Report','','2022-12-30','<p>Outcome Report</p>','Open','Outcome','','6','4');
INSERT INTO "outfunds__Requirement__c" VALUES(7,'Budget Report','','2021-12-30','<p><span style="color: rgb(0, 0, 0); font-size: 10pt; font-family: Arial;">Budget Report</span></p>','Open','Report','','6','4');
INSERT INTO "outfunds__Requirement__c" VALUES(8,'Application','2019-03-21','2019-12-30','<p><span style="font-family: Arial; font-size: 10pt; color: rgb(0, 0, 0);">Application</span></p>','Accepted','Final Application','','2','6');
INSERT INTO "outfunds__Requirement__c" VALUES(9,'Outcome Report','','2020-12-30','<p>Outcome Report</p>','Open','Outcome','','2','6');
INSERT INTO "outfunds__Requirement__c" VALUES(10,'Proposed Budget','2019-03-21','2019-12-30','<p>Proposed budget</p>','Accepted','Report','','2','6');
INSERT INTO "outfunds__Requirement__c" VALUES(11,'Budget Report','2020-02-11','2020-12-30','<p>Budget Report</p>','Complete','Report','','2','6');
INSERT INTO "outfunds__Requirement__c" VALUES(12,'Letter of Intent','2019-03-21','2019-12-30','<p><span style="font-family: Arial; font-size: 10pt; color: rgb(0, 0, 0);">Cover letter</span></p>','Accepted','Letter of Intent','','2','6');
COMMIT;
