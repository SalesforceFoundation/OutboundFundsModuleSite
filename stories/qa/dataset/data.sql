...
INSERT INTO "outfunds__Disbursement__c" VALUES(1,'40000.0','2019-05-14','EFT','2019-05-14','Paid','Final','5');
INSERT INTO "outfunds__Disbursement__c" VALUES(2,'10000.0','2020-03-28','EFT','2020-03-28','Paid','Initial','2');
INSERT INTO "outfunds__Disbursement__c" VALUES(3,'5000.0','2019-07-09','EFT','2019-07-09','Paid','Initial','3');
INSERT INTO "outfunds__Disbursement__c" VALUES(4,'5000.0','2020-07-09','','2020-07-09','Paid','Interim','3');
INSERT INTO "outfunds__Disbursement__c" VALUES(5,'5000.0','','EFT','2021-07-09','Scheduled','Final','3');
...
INSERT INTO "outfunds__Funding_Request_Role__c" VALUES(1,'Applicant','Current','3','2');
INSERT INTO "outfunds__Funding_Request_Role__c" VALUES(2,'Applicant','Former','7','5');
INSERT INTO "outfunds__Funding_Request_Role__c" VALUES(3,'Grant Manager','Current','2','2');
...
INSERT INTO "outfunds__Funding_Request__c" VALUES(1,'Grantwood City Food Bank','','','','','','City','Below Poverty level;Economically Disadvantaged People;Homeless','','100000.0','Grantwood City Food Bank','In progress','','','','','2','4');
INSERT INTO "outfunds__Funding_Request__c" VALUES(2,'Takagawa Institute: Relief and Reinvestment Grant','2020-03-11','10000.0','2020-03-28','2020-03-28','Fully awarded.','Country','Immigrants and Refugees','10000.0','10000.0','','Fully Disbursed','2021-03-27','2020-03-28','One time payment with one year follow up','3','3','5');
INSERT INTO "outfunds__Funding_Request__c" VALUES(3,'Eager Beavers Read!','2019-04-25','15000.0','2019-07-09','','','City','Children and Youth','15000.0','15000.0','Eager Beavers Read! is an after school program that helps foster a love of reading in our 1st - 5th grade classes and also provides a safe place for students to go between 3:00 pm and 4:30 pm. Younger children will be paired up with an older student to help expand their early literacy skills, while older students work to develop mentoring skills and confidence.','Awarded','2022-08-13','2019-08-14','3 years','4','5','2');
INSERT INTO "outfunds__Funding_Request__c" VALUES(4,'STEPS to Leadership','2020-02-16','28000.0','','','','Region','Adults;Women','28000.0','28000.0','STEPS to Leadership is a proposed program that came from requests for additional leadership training for our graduates from Skills for Success, a successful program we currently offer to at-risk women in the community. After completing Skills for Success, graduates can learn leadership skills through various trainings, seminars, and one-on-one mentoring that will help prepare these future female leaders.','Submitted','','','','5','6','4');
INSERT INTO "outfunds__Funding_Request__c" VALUES(5,'Skills for Success','2019-03-21','40000.0','2019-05-14','','','Region','Adults;Women','40000.0','40000.0','Skills for Success addresses an existing gap for at-risk women seeking to learn technical and soft skills to help them find gainful employment in the community. Participants of the program receive:
...
INSERT INTO "outfunds__Funding_Request__c" VALUES(6,'Skills for Success','2020-05-31','','','','','Region','Adults;Women','','46000.0','Skills for Success addresses an existing gap for at-risk women seeking to learn technical and soft skills to help them find gainful employment in the community. Participants of the program receive:
